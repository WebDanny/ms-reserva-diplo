...
public class CreateReserveHandler implements Command.Handler<CreateReserveCommand, ReserveDTO> {
  ...
  public CreateReserveHandler(
      IReserveRepository reserveRepository, KafkaTemplate<Long, Reserve> template) {
  ...
  public ReserveDTO handle(CreateReserveCommand request) {
    ...
    try {
      reserve =
          reserveFactory.createReserve(
              request.reserveDTO.getDateIn(),
              request.reserveDTO.getDateOut(),
              request.reserveDTO.getDetails(),
