...
import com.nur.command.person.reserva.GetPersonReservaQuery;
...
public class PersonsController {
    ...
    @GetMapping("/persona/{personId}/reservas")
    public List<PersonDTO> getListReserva(String personId) {
        GetPersonReservaQuery query = new GetPersonReservaQuery(personId);
        return query.execute(pipeline);
